...
//总条数
$sql = "SELECT count(*) as c from {$pre_}comment where $where";
$count = $db->find($sql);
...
$sql = "SELECT * FROM {$pre_}comment WHERE $where ORDER BY id desc LIMIT $data_start,$limit";
  ...
  <div class="fly-panel fly-panel-user" pad20>
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      <ul class="layui-tab-title" id="LAY_mine">
        <li class="layui-this" lay-id="info">评论记录</li>
      </ul>
        ...
        <table class="layui-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="comment_info.php?postid=<?php echo $item['id'];?>">查看详细</a>
              </td>
            </tr>
            <?php }?>
          </tbody>
...
<script>
  ...
  arr[5].classList.add('layui-this');
</script>